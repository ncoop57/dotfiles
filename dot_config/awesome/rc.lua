...
terminal = "/home/nathan/.local/kitty.app/bin/kitty"
...
tags = {
  settings = {
    { names  = { "Main", "Dev", "Notes", 4, 5 },
      layout = { layouts[2], layouts[1], layouts[1], layouts[4] }
    },
    { names  = { "Web", "Chat", "Music", 4, 5 },
...
awful.screen.connect_for_each_screen(function(s)
    ...
    -- awful.tag({ "Main", "Web", "Dev", "Chat", "6", "7", "8", "9" }, s, awful.layout.layouts[1])
...
globalkeys = gears.table.join(
    ...
    -- Volume Control
    awful.key({}, "XF86AudioRaiseVolume", function ()  volume_widget:inc(5) end, -- awful.util.spawn("amixer -D pulse sset Master 2%+", false) end,
    ...
    -- Lock Screen
    awful.key({ modkey, "Control" }, "l", function () awful.util.spawn("i3lock \
        --color=282828 \
...
awful.rules.rules = {
    ...
    -- Set applications to run on specific tags.
    -- Web Browser
    { rule = { instance = "Navigator" },
        -- open on current active screen
        properties = { screen = 2, tag = "Web", switchtotag = true } },
    -- Dev
    { rule = { instance = "code" },
        properties = { screen = 1, tag = "Dev", switchtotag = true } },
    -- Music
    { rule = { instance = "crx_cinhimbnkkaeohfgghhklpknlkffjgod" },
        properties = { screen = 2, tag = "Music", switchtotag = true } },
    -- Notes
    { rule = { instance = "obsidian" },
        properties = { screen = 1, tag = "Notes", switchtotag = true } },
    -- Chat
...
awful.spawn.with_shell("google-chrome \"--profile-directory=Profile 3\" --app-id=cinhimbnkkaeohfgghhklpknlkffjgod")
...
-- Terminal apps
-- weather_cmd = terminal .. " -e " .. "textual run ~/textual/weather/weather_app.py --dev"
-- awful.spawn.with_shell(weather_cmd, {
--     tag = "Main",
--     screen = 1,
--     placement = awful.placement.bottom_right
-- })

-- neofetch_cmd = terminal .. " -e " .. "neofetch"
-- awful.spawn.with_shell(neofetch_cmd, {
--     tag = "Main",
--     screen = 1,
--     placement = awful.placement.bottom_right
-- })
